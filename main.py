...
llm = ChatGroq(model_name = 'llama-3.2-90b-text-preview', api_key=groq_api_key)

def get_few_shot_db_chain():
    db_user = "root"
    db_password = "root"  # Replace with your actual password
    db_host = "127.0.0.1"  # Using the hostname you provided
    db_port = "3306"  # Port number for MySQL
    db_name = "atliq_tshirts"

    # Correct URI with hostname and port
...
if __name__ == "__main__":
    ...
    print(chain.run("how many white tshorts are in stock?"))